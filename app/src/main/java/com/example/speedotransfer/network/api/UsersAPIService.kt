...
import com.example.speedotransfer.api.BalanceAPICallable
...
object UsersAPIService {
    private val token=
        MyApplication.appContext.getSharedPreferences("MyPreferences", Context.MODE_PRIVATE).getString("token", "") ?: ""
    ...
    val balanceAPI: AuthAPI = retrofit.create(AuthAPI::class.java)
