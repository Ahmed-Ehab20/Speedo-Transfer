...
fun MorePage(modifier: Modifier = Modifier) {
    ...
    Column(modifier= Modifier
        ...
        SpeedoMore(icon = R.drawable.danger, text = "Help",onClick = { showBottomSheet = true
        },modifier= Modifier
            .fillMaxWidth(0.9f))
    ...
    if (showBottomSheet) {
        ModalBottomSheet(
            ...
            Row (modifier= Modifier
                ...
                Card(colors = CardDefaults.cardColors(containerColor = Color.White), elevation = CardDefaults.elevatedCardElevation(2.dp),modifier=Modifier.padding(start=32.dp).clickable {  }) {
