...
fun SignUp(modifier: Modifier = Modifier) {
    ...
    Column(
        ...
        SpeedoTextField(title = "Full Name",
        ...
        SpeedoTextField(title = "Password",
        ...
        SpeedoTextField(title = "Confirm Password",
            label = "Enter your Password",
            icon = R.drawable.email,
        ...
        SpeedoButton(label = "Sign up", onClick = {  },modifier = Modifier
            .fillMaxWidth(0.9f)
            .padding(top = 32.dp))
