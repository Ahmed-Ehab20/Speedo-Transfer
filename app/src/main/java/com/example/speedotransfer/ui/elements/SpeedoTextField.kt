...
fun SpeedoTextField(
    ...
    onDoneAction: (() -> Unit)? = null // Add callback for 'done' action
) {
    ...
    Column(modifier = modifier) {
        ...
        OutlinedTextField(
            ...
            colors = if (errorMessage == null) {
                OutlinedTextFieldDefaults.colors(
                    ...
                    focusedTrailingIconColor = Gray700,
                    unfocusedTrailingIconColor = Gray70
                )
            } else {
                OutlinedTextFieldDefaults.colors(
                    focusedBorderColor = Danger300,
                    unfocusedBorderColor = Danger300,
                    focusedTextColor = Danger300,
                    unfocusedTextColor = Gray700,
                    focusedTrailingIconColor = Danger300,
                    unfocusedTrailingIconColor = Danger300
                )
            },
            textStyle = TextStyle(
                fontSize = 18.sp,
        ...
        if (errorMessage != null)
            Text(
                text = errorMessage ?: "", fontSize = 14.sp, modifier = Modifier
                    .padding(top = 8.dp)
                    .fillMaxWidth()
                    .alpha(if (errorMessage != null) 1f else 0f), color = Danger300
            )
